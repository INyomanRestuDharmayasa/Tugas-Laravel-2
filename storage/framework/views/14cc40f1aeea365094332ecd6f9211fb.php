...
<div class="container">
    ...
    <p><strong>ID:</strong> <?php echo e($mahasiswa['id']); ?></p>
    <p><strong>NIM:</strong> <?php echo e($mahasiswa['nim']); ?></p>
    <p><strong>Nama:</strong> <?php echo e($mahasiswa['nama']); ?></p>
    <p><strong>Prodi:</strong> <?php echo e($mahasiswa['prodi']); ?></p>

    <a href="<?php echo e(route('mahasiswa.index')); ?>">Kembali</a>
</div>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\kampus-laravel\resources\views/mahasiswa/show.blade.php ENDPATH**/ ?>