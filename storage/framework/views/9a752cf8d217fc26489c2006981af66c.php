        ...
        <div class="mb-3">
            ...
            <select name="fakultas" id="fakultas" class="form-select">
                ...
                <?php $__currentLoopData = $fp; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fakultas => $prodis): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($fakultas); ?>" <?php echo e(old('fakultas') == $fakultas ? 'selected' : ''); ?>>
                        <?php echo e($fakultas); ?>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function(){
        const oldFak = "<?php echo e(old('fakultas')); ?>";
        const oldProdi = "<?php echo e(old('prodi')); ?>";
        if(oldFak){
...
<?php /**PATH C:\xampp\htdocs\kampus-laravel\resources\views/mahasiswa/create.blade.php ENDPATH**/ ?>